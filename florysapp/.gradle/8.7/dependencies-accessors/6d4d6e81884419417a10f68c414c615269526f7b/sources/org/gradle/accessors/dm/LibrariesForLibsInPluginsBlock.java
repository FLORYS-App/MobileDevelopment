...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class TensorflowLiteLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final TensorflowLiteModelLibraryAccessors laccForTensorflowLiteModelLibraryAccessors = new TensorflowLiteModelLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>tensorflow.lite.model</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public TensorflowLiteModelLibraryAccessors getModel() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForTensorflowLiteModelLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class TensorflowLiteModelLibraryAccessors extends SubDependencyFactory {

        public TensorflowLiteModelLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>metadata</b> with <b>org.tensorflow:tensorflow-lite-model-metadata</b> coordinates and
         * with version reference <b>tensorflowLiteModelMetadata</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getMetadata() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("tensorflow.lite.model.metadata");
        }
    ...
    public static class TensorflowTensorflowLiteLibraryAccessors extends SubDependencyFactory {
        ...
        public Provider<MinimalExternalModuleDependency> getSupport() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("tensorflow.tensorflow.lite.support");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlinGradlePlugin</b> with value <b>1.8.20</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tensorflowLiteModelMetadata</b> with value <b>0.4.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTensorflowLiteModelMetadata() { return getVersion("tensorflowLiteModelMetadata"); }
